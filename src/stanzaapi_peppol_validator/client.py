...
class PeppolValidatorClient:
    """Official zero-dependency client for Peppol BIS Billing 3.0 & EN 16931 E-Invoice Engine."""
    ...
    def __init__(
        ...
        self.tier = tier
        self.tool_url = "https://stanzaapi.com/tools/peppol-validator"
    ...
    def _request(self, endpoint: str, method: str = "GET", body: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        headers = {
            ...
            "User-Agent": "stanzaapi-peppol-validator-python/1.0.0"
        }
        if self.api_key:
